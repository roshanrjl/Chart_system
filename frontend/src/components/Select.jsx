      ...
      <div className="relative mt-2">
        <Combobox.Button className="w-full">
          <Combobox.Input
            ...
            className="block w-full rounded-xl border-0 py-4 px-5 bg-secondary outline outline-[1px] outline-zinc-400 text-black font-light placeholder:text-black/70 focus:ring-[1px] focus:ring-white"
            onChange={(e) => {
              setLocalOptions(
              ...
              <Combobox.Option
                ...
                className={({ active }) =>
                  classNames(
                    ...
                    active ? "bg-dark text-blue-600" : "text-black"
                  )
                }
              >
                {({ active, selected }) => (
