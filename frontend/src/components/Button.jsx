  ...
  return (
    <button
      ...
      className={classNames(
        "rounded-full inline-flex flex-shrink-0 justify-center items-center text-center text-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white shadow-sm",
        fullWidth ? "w-full" : "",
        severity === "secondary"
